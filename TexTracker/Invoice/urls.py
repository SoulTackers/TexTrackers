...
urlpatterns = [
    ...
    path('listinvoice/invoice/<int:id>/update',invoice_update_view,name='update-invoice'),
    path('listinvoice/invoice/<int:id>/delete',DeleteInvoiceView,name='delete-invoice'),
