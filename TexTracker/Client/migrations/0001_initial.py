...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('client_password_vat', models.CharField(blank=True, db_column='client_password_VAT', max_length=60, null=True)),
                ('client_password_it', models.CharField(blank=True, db_column='client_password_IT', max_length=60, null=True)),
                ('client_passwordclient_password_tds', models.CharField(blank=True, db_column='client_passwordclient_password_TDS', max_length=60, null=True)),
                ('client_password_st', models.CharField(blank=True, db_column='client_password_ST', max_length=60, null=True)),
                ('client_password_excise', models.CharField(blank=True, max_length=60, null=True)),
                ('client_password_vat_unique_id', models.CharField(blank=True, db_column='client_password_VAT_unique_id', max_length=60, null=True)),
                ('client', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='Client.Client')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('client_bank_info_bank_name', models.CharField(blank=True, max_length=60, null=True)),
                ('client_bank_info_account_no', models.BigIntegerField(blank=True, null=True)),
                ('client_bank_info_branch', models.CharField(blank=True, max_length=60, null=True)),
                ('client', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='Client.Client')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('client_acc_info_accountant_name', models.CharField(blank=True, max_length=60, null=True)),
                ...
                ('client_acc_info_accountant_counsultant_name', models.CharField(blank=True, max_length=60, null=True)),
                ...
                ('client_acc_info_ca_name', models.CharField(blank=True, max_length=60, null=True)),
